    ...
    <div class="max-w-8xl mx-auto sm:px-6 lg:px-8 z-10 relative">
        <div>
            ...
            <div class="mt-2 grid gap-5 grid-cols-12 bg-white dark:bg-gray-800 pt-5 px-4 py-6 shadow rounded-lg overflow-hidden">
                ...
                <div class="col-span-12">
                    <label for="name" class="block text-md font-medium text-gray-700 mb-1 dark:text-gray-400"
                        >Provider or wallet address</label
                    >
                    <input
                ...
                <div class="lg:col-span-2 col-span-6">
                    <label class="form-label dark:text-gray-300"
                        >Min Memory <span class="text-sm font-medium text-gray-400">GB</span></label
                    >
                    <input
                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-2 w-full block sm:text-sm border-2 border-gray-100 rounded-md"
                        type="number"
                ...
                <div class="lg:col-span-2 col-span-6">
                    <label for="memorymax" class="dark:text-gray-300"
                        >Max Memory <span class="text-sm font-medium text-gray-400">GB</span></label
                    >
                    <input
                        name="memorymax"
                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-2 w-full block sm:text-sm border-2 border-gray-100 rounded-md"
                ...
                <div class="lg:col-span-2 col-span-6">
                    <label for="diskmax" class="dark:text-gray-300"
                        >Max Disk <span class="text-sm font-medium text-gray-400">GB</span></label
                    >
                    <input
                        name="diskmax"
                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-2 w-full block sm:text-sm border-2 border-gray-100 rounded-md"
                ...
                <div class="lg:col-span-2 col-span-6">
                    <label class="form-label dark:text-gray-300"
                        >Min CPU/h <span class="text-sm font-medium text-gray-400">GLM</span></label
                    >
                    <input
                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-2 w-full block sm:text-sm border-2 border-gray-100 rounded-md"
                        type="number"
                ...
                <div class="lg:col-span-2 col-span-6">
                    <label for="cpuhmax" class="dark:text-gray-300"
                        >Max CPU/h <span class="text-sm font-medium text-gray-400">GLM</span></label
                    >
                    <input
                        name="cpuhmax"
                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-2 w-full block sm:text-sm border-2 border-gray-100 rounded-md"
                ...
                <div class="lg:col-span-2 col-span-6">
                    <label class="form-label dark:text-gray-300"
                        >Min Env/h <span class="text-sm font-medium text-gray-400">GLM</span></label
                    >
                    <input
                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-2 w-full block sm:text-sm border-2 border-gray-100 rounded-md"
                        type="number"
                ...
                <div class="lg:col-span-2 col-span-6">
                    <label for="envmax" class="dark:text-gray-300"
                        >Max Env/h <span class="text-sm font-medium text-gray-400">GLM</span></label
                    >
                    <input
                        name="envmax"
                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-2 w-full block sm:text-sm border-2 border-gray-100 rounded-md"
                ...
                <div class="lg:col-span-2 col-span-6">
                    <label class="form-label dark:text-gray-300"
                        >Min Start price <span class="text-sm font-medium text-gray-400">GLM</span></label
                    >
                    <input
                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 p-2 w-full block sm:text-sm border-2 border-gray-100 rounded-md"
                        type="number"
                ...
                >
                    <template #head>
                        <tr>
                            <th
                                scope="col"
                                class="px-6 py-5 text-left text-xs font-medium text-white uppercase tracking-wider rounded-l-lg"
                            >
                                Provider
                            </th>
                        ...
                        >
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-12 w-12 bg-golemblue rounded-md p-3 relative">
                                        <div v-if="provider.Computing">
                                            <div
                                                class="absolute top-0 right-0 -mr-1 -mt-1 w-3 h-3 rounded-full bg-red-500 animate-ping"
                                            ></div>
                                            <div class="absolute top-0 right-0 -mr-1 -mt-1 w-3 h-3 rounded-full bg-red-500"></div>
                                        </div>
                                        <div v-else>
                                            <div
                                                class="absolute top-0 right-0 -mr-1 -mt-1 w-3 h-3 rounded-full bg-green-300 golemping animate-ping"
                                            ></div>
                                            <div
                                                class="absolute top-0 right-0 -mr-1 -mt-1 w-3 h-3 rounded-full bg-green-300 golemping"
                                            ></div>
                                        </div>
                            ...
                            <td class="px-6 py-4">
                                <dt class="flex flex-row items-center">
                                    ...
                                    <p class="ml-2 text-sm font-medium text-gray-900 golemtext dark:text-gray-300">
                                        {{ provider.Memory }} GB
                                    </p>
                                </dt>
                            </td>
