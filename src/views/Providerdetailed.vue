...
<template>
  ...
  <div class="min-h-full">
    <main class="py-10">
      ...
      <div class="max-w-4xl mx-auto py-4 rounded-lg md:flex md:items-center md:justify-between md:space-x-5 lg:max-w-7xl lg:px-8 bg-white">
        <div class="flex items-center space-x-5 ">
          ...
          <div>
            <div class="flex flex-row  items-center ">
              <h1 class="text-2xl font-bold text-gray-900 pr-2">
                {{this.name}}
              </h1>
      ...
      <div class="mt-8 max-w-3xl mx-auto grid grid-cols-1 gap-6 sm:px-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
        <section aria-labelledby="timeline-title" class="lg:col-start-1 lg:col-span-4">
          ...
          <dl class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <div v-if="this.income['24']" class="relative bg-white pt-5 px-4 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
              <dt>
                <div class="absolute bg-golemblue rounded-md p-3">
                  <component :is="icon" class="h-6 w-6 text-white" aria-hidden="true" />
                </div>
                <p class="ml-16 text-sm font-medium text-gray-500 truncate">Earnings (24h)</p>
              </dt>
            ...
            <div v-if="this.income['168']" class="relative bg-white pt-5 px-4 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
              <dt>
                <div class="absolute bg-golemblue rounded-md p-3">
                  <component :is="icon" class="h-6 w-6 text-white" aria-hidden="true" />
                </div>
                <p class="ml-16 text-sm font-medium text-gray-500 truncate">Earnings (7d)</p>
              </dt>
              <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
                <p class="text-2xl font-semibold text-gray-900">
                  {{ this.income['168'] }}
            ...
            <div v-if="this.income['744']" class="relative bg-white pt-5 px-4 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
              <dt>
                <div class="absolute bg-golemblue rounded-md p-3">
                  <component :is="icon" class="h-6 w-6 text-white" aria-hidden="true" />
                </div>
                <p class="ml-16 text-sm font-medium text-gray-500 truncate">Earnings (31d)</p>
              </dt>
              <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
                <p class="text-2xl font-semibold text-gray-900">
                  {{ this.income['744'] }}
            ...
            <div class="relative bg-white pt-5 px-4 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
              <dt>
                ...
                <p class="ml-16 text-sm font-medium text-gray-500 truncate">Earnings (90d)</p>
              </dt>
              <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
                <p class="text-2xl font-semibold text-gray-900">
                  {{ this.income['8760'] }}
        ...
        <div class="space-y-6 lg:col-start-1 lg:col-span-2">
          ...
          <section aria-labelledby="applicant-information-title">
            ...
            <div class="bg-white mt-2 pt-5 px-4 sm:py-6 sm:px-6 shadow rounded-lg">
              <h1 class="text-xl font-medium">Tasks being computed</h1>
              <p class="text-sm  text-gray-500">1 = Computing / 0 = Inactive</p>
            ...
            <dl class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-1">
              <div class="relative bg-white pt-5 px-4 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
                <dt>
                  ...
                  <p class="ml-16 text-sm font-medium text-gray-500 truncate">Model</p>
                </dt>
                <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
                  <p class="text-2xl font-semibold text-gray-900">
                    {{ cores}}
                  </p>
                  <p class="text-golemblue ml-2 flex items-baseline text-sm font-semibold">
                    Cores
                  </p>
                </dd>
              </div>
              <div class="relative bg-white pt-5 px-4 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
                <dt>
                  ...
                  <p class="ml-16 text-sm font-medium text-gray-500 truncate">RAM</p>
                </dt>
                <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
                  <p class="text-2xl font-semibold text-gray-900">
                    {{memory}}
              ...
              <div class="relative bg-white pt-5 px-4 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
                <dt>
                  ...
                  <p class="ml-16 text-sm font-medium text-gray-500 truncate">DISK</p>
                </dt>
                <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
                  <p class="text-2xl font-semibold text-gray-900">
                    {{disk}}
