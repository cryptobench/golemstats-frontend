    ...
    <div class="min-h-full">
        <main class="py-10">
            ...
            <div class="mt-8 max-w-3xl mx-auto grid grid-cols-1 gap-6 sm:px-6 lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-3">
                <div
                    class="bg-thorg golemshadow golemshadow col-span-12 rounded-lg px-6 overflow-auto py-4 md:flex md:items-center md:justify-between md:space-x-5"
                >
                    <div class="flex items-center space-x-5">
                        ...
                        <div>
                            <div class="flex flex-row items-center">
                                ...
                                <span
                                    class="px-2 golemring inline-flex text-xs leading-5 font-semibold rounded-full golemgradient text-white"
                                >
                                    Thorg miner
                                </span>
                            </div>
