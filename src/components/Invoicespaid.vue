<template>
  <div class="bg-white dark:bg-gray-800 pt-5 px-4 sm:px-6 shadow rounded-lg overflow-hidden">
    <div class="relative">
      ...
      <h3 class="text-2xl mb-2 font-medium dark:text-gray-300">Invoices Paid (1h)</h3>
      <span class="dark:text-gray-400"
        ...
        ></span
      >
      <apexchart width="100%" class="py-6 px-24" height="250" type="radialBar" :options="chartOptions" :series="series"></apexchart>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      ...
      axios.get("https://api.stats.golem.network/v1/network/market/invoice/paid/1h").then((response) => {
