    ...
    return (
        <div className="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 col-span-12 gap-4">
                <HistoricalSpecs endpoint="network/historical/stats" title="Providers Online" colors={["#3F51B5"]} yaxisLabel="Providers" />
                <HistoricalSpecs endpoint="network/historical/stats" title="Amount of Cores" colors={["#3F51B5"]} yaxisLabel="Cores" />
                <HistoricalSpecs endpoint="network/historical/stats" title="TB of Memory" colors={["#3F51B5"]} yaxisLabel="Memory" />
                <HistoricalSpecs endpoint="network/historical/stats" title="TB of Disk" colors={["#3F51B5"]} yaxisLabel="Disk" />
            </div>
