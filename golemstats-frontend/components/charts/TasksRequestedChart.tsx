  ...
  const series = [
    {
      data: apiResponse
        ...
        .map((obj: { tasks_requested: number }, i: number) => ({
          x: `Requestor ${i + 1}`,
    ...
    <div className="bg-white dark:bg-gray-800 pt-5 mb-2 px-4 sm:px-6 shadow rounded-lg overflow-hidden">
      <div className="relative">
        ...
        <h1 className="text-2xl mb-2 font-medium dark:text-gray-300">
          Amount of tasks requested by requestors
        </h1>
        <label
          htmlFor="name"
        ...
        <input
          ...
          id="name"
          type="number"
          className="shadow-sm mb-2  p-2 w-full block sm:text-sm  rounded-md dark:bg-gray-700 dark:text-gray-400"
        />
        <label
          htmlFor="height"
          className="block text-sm font-medium text-gray-700 mb-1 dark:text-gray-300"
