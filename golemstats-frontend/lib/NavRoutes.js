...
export const providerCTA = [
    { name: "Become a provider", href: "https://handbook.golem.network/provider-tutorials/provider-tutorial", icon: RectangleGroupIcon },
    {
...
export const NetworkCTA = [
    { name: "Main Website", href: "https://golem.network", icon: RectangleGroupIcon },
    {
        name: "Golem Portal",
